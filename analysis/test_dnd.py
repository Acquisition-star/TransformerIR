...
parser.add_argument('--input_dir', default=r'D:\Data\Denoising\DND', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/denoising/DND/', type=str, help='Directory for results')
