...
class HAB(nn.Module):
    ...
    def forward(self, x):
        ...
        # Conv_X
        conv_x = self.conv_block(x.permute(0, 3, 1, 2))  # B C H W
        ...
        x = self.drop_path(attn_x).reshape(b, c, h, w) + conv_x * self.conv_scale

        return x


if __name__ == '__main__':
    model = HAB(dim=32, num_heads=8, shift_size=2)
