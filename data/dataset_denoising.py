...
class Dataset_denoising_train(Dataset):
    def __init__(self, patch_size, sigma, input_channels, H_path, L_path):
        super(Dataset_denoising_train, self).__init__()
...
class Dataset_denoising_val(Dataset):
    def __init__(self, sigma, input_channels, H_path, L_path):
